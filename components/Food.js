...
},
{
    id: '15',
    name: 'Lipton Chai',
    description: 'Aromatic tea made with Lipton tea leaves and traditional Indian spices.',
    price: '2.99',
    quantity: 0,
...
},
{
    id: '16',
    name: 'Masala Chai',
    description: 'Traditional Indian tea made with black tea, milk, and a blend of aromatic spices.',
    price: '2.99',
    quantity: 0,
...
},
{
    id: '17',
    name: 'Punjabi Lassi',
    description: 'Refreshing yogurt drink made with yogurt, sugar, and flavored with saffron and cardamom.',
    price: '3.99',
    quantity: 0,
...
},
{
    id: '18',
    name: 'Noon Chai',
    description: 'Traditional tea from Kashmir made with green tea, milk, salt, and flavored with cardamom and cinnamon.',
    price: '3.99',
    quantity: 0,
...
},
{
    id: '19',
    name: 'Kahwa',
    description: 'Traditional Kashmiri tea made with green tea, saffron, cinnamon, cardamom, and almonds.',
    price: '3.99',
    quantity: 0,
...
},
{
    id: '20',
    name: 'Nimbu Pani',
    description: 'Refreshing lemonade made with freshly squeezed lemons, water, and sugar.',
    price: '1.99',
    quantity: 0,
...
},
{
    id: '21',
    name: 'Badam Milk',
    description: 'A creamy almond milk flavored with saffron, cardamom, and rose water.',
    price: '2.99',
    quantity: 0,
...
},
{
    id: '22',
    name: 'Thandai',
    description: 'A popular drink from North India made with milk, almonds, saffron, cardamom, and fennel seeds.',
    price: '0.99',
    quantity: 0,
...
},
{
    id: '23',
    name: 'Kashmiri Roth',
    description: 'Indulge in the sweet aroma and rich flavors of Kashmir with our Kashmiri Roth, a traditional sweet bread that is a true culinary masterpiece. Made with love and care, our Roth is a soft, flaky, and melt-in-your-mouth delight that will satisfy your sweet tooth like no other. This authentic Kashmiri specialty is prepared with a blend of aromatic spices, nuts, and dried fruits, creating a perfect harmony of flavors. Our Roth is handcrafted with the finest ingredients and baked to perfection, resulting in a golden, crispy crust that gives way to a luscious, sweet filling that will leave you craving for more.',
    price: '25.99',
    quantity: 0,
...
},
{
    id: '24',
    name: 'Kulfi',
    description: 'A type of Indian ice cream thats flavored with saffron, cardamom, and pistachios. It is usually served on a stick.',
    price: '2.99',
    quantity: 0,
    image: require('../assets/images/Kulfi.png')
},
{
    id: '25',
    name: 'Phirni',
    description: 'A rice pudding made with ground rice, milk, sugar, and cardamom. It is usually served chilled and garnished with chopped nuts.',
    price: '3.99',
    quantity: 0,
    image: require('../assets/images/Phirni.png')
},
{
    id: '26',
    name: 'Kesar Kheer',
    description: 'A rice pudding made with milk, sugar, and cardamom. It is  usually served hot or chilled and topped with chopped nuts.',
    price: '5.99',
    quantity: 0,
    image: require('../assets/images/kesarKheer.png')
},
{
    id: '27',
    name: 'Modur Pulao',
    description: 'A sweet and fragrant Kashmiri rice dish made with ghee, saffron, nuts, and raisins.',
    price: '5.99',
    quantity: 0,
    image: require('../assets/images/modurPulao.jpg.png')
},
{
    id: '28',
    name: 'Shufta',
    description: 'A traditional Kashmiri dessert made with dry fruits, nuts, paneer, and sugar syrup.It is often served during weddings and other special occasions.',
    price: '3.99',
    quantity: 0,
    image: require('../assets/images/Shufta.png')
},
{
    id: '29',
    name: 'Seekh Kabab',
    description: 'A popular Indian street food made with minced meat and spices that are skewered and grilled over charcoal.',
    price: '9.99',
    quantity: 0,
    image: require('../assets/images/seekhKabab.png')
}, 
{
    id: '30',
    name: 'Tabak Maaz',
    description: 'A dish made with deep-fried lamb ribs that are marinated in yogurt and spices.',
    price: '10.99',
    quantity: 0,
    image: require('../assets/images/tabakhMaaz.jpg.webp.png')
},
{
    id: '31',
    name: 'Shami Kebab',
    description: 'A type of kebab made with minced meat, lentils, and spices that are shaped into small patties and fried.',
    price: '5.99',
    image: require('../assets/images/ChickenShamiKabab.png')
},
{
    id: '32',
    name: 'Kachalu Chaat',
    description: ' A popular street food made with boiled potatoes, spices, and chutney. It is usually served with crispy fried bread or puffed rice.',
    price: '5.99',
    image: require('../assets/images/kachaluChaat.webp.png')
},
];
