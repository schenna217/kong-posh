...
},
{
    ...
    price: '$15.99',
    image: require('../assets/images/Dum_Aloo.JPG')
},
{
    id: '4',
    name: 'Dum Biryani',
    ...
    price: '$28.50',
    image: require('../assets/images/Dum_Biryani.JPG')
},
{
    id: '5',
    name: 'Flat Roth',
    ...
    price: '$9.99',
    image: require('../assets/images/Flat_Roth.JPG')
},
{
    id: '6',
    ...
    price: '$10.99',
    image: require('../assets/images/Gobi_Paneer_Ki_Sabzi.JPG')
},
{
    id: '7',
    name: 'Kashmiri Laddu',
...
},
{
    ...
    description: 'Kashmiri Laddu is a traditional sweet delicacy from the Kashmiri cuisine, which originates from the Kashmir Valley in India. It is a popular dessert made from a combination of ingredients including roasted cashews, ghee (clarified butter), sugar, cardamom, saffron, and sometimes rose water. The roasted cashews are ground to a fine powder and then mixed with ghee, sugar, and aromatic spices to form a dough-like consistency. The mixture is then shaped into small balls or discs and garnished with saffron strands or chopped nuts for added flavor and visual appeal. Kashmiri Laddu is known for its rich, nutty flavor, delicate fragrance from the cardamom and saffron, and its melt-in-your-mouth texture. It is often served during festive occasions, weddings, and other celebrations as a symbol of joy and happiness.',
    price: '$10.99',
    image: require('../assets/images/Kashmiri_Roth.JPG')
},
{
    id: '10',
    name: 'Kashmiri Roth',
    ...
    price: '$10.99',
    image: require('../assets/images/Kashmiri_Ther_Rice.JPG')
},
{
    id: '10',
    name: 'Kashmiri Tehri Rice',
    description: 'Experience the taste of Kashmir with our Kashmiri Tehri, a flavorful and aromatic yellow rice dish that will elevate your dining experience to new heights. Made with the finest Basmati rice, our Tehri is infused with a medley of authentic Kashmiri spices, including cinnamon, cardamom, cloves, and fennel seeds, which lend it a unique and exotic flavor profile. The bright yellow color of the rice comes from turmeric, which also adds a subtle warmth and depth to the dish. Loaded with a generous assortment of vegetables and sometimes even tender chunks of meat, our Tehri is a wholesome and nourishing meal that is as visually appealing as it is delicious. Each forkful of our Kashmiri Tehri is a symphony of flavors, with the delicate fragrance of the spices and the richness of the Basmati rice coming together in a culinary harmony that will leave your taste buds tingling with delight. Perfect as a standalone main course or as a side dish to complement other Kashmiri specialties, our Kashmiri Tehri is a true celebration of flavors that will transport your guests to the picturesque valleys of Kashmir. Let us bring the magic of Kashmir to your table with our delectable and aromatic Tehri, a true masterpiece that will captivate your senses and leave your guests craving for more.',
    price: '$6.99',
    image: require('../assets/images/Kashmiri_Ther_Rice.JPG')
},
{
    ...
    price: '$10.99',
    image: require('../assets/images/Katlam.JPG')
},
{
    id: '12',
    ...
    price: '$8.99',
    image: require('../assets/images/Makki_Ki_Roti_Sarso_Ka_Saag.JPG')
},
{
    id: '13',
    name: 'Matz',
    ...
    price: '$11.99',
    image: require('../assets/images/Matz.JPG')
},
{
    id: '14',
    name: 'Yakni',
